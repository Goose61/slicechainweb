    ...
    try {
      await businessApi.signupRequest({
        ...
        primaryContact: {
          ...
          jobTitle: form.primaryContactTitle,
        ...
        solanaWallet: {
          address: form.solanaWalletAddress.trim(),
        },
        servicesRequested: {
          ...
          otherDetails: form.servicesOtherDetails || undefined,
        },
        declaration: {
          authorizedRepresentativeName: form.authorizedRepName,
          positionTitle: form.authorizedRepTitle,
