...
export default function CustomerLoginPage() {
  ...
  const { siteKey, turnstileRequired, widgetRef, getToken, onVerify, onExpire, onError, resetToken } = useTurnstile();
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    setLoading(true);
    try {
      const data = await customerApi.login(email, password, turnstileToken || undefined);
